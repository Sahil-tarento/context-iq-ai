...
export function activate(context: vscode.ExtensionContext) {
    ...
    let askCommand = vscode.commands.registerCommand('contextiq.ask', async () => {
        ...
        vscode.window.withProgress({
            ...
            try {
                ...
                const response = await axios.post(`${CONTEXTIQ_API_URL}/chat`, {
                    query: query,
    ...
    let indexCommand = vscode.commands.registerCommand('contextiq.index', async () => {
        ...
        vscode.window.withProgress({
            ...
            try {
                const response = await axios.post(`${CONTEXTIQ_API_URL}/index`, {
                    repo_path: workspaceFolder
                });
...
function getWebviewContent(query: string, data: any) {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
